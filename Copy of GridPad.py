...
class GridPad(wx.Frame):
	...
	def __init__(self, parent, id, owner=None, topLevel = None):
	...
	def createMainGrid(self, panel):
		font = wx.Font(pointSize=10, family=0, style=wx.NORMAL, weight=wx.NORMAL, faceName="Verdana", encoding=wx.FONTENCODING_DEFAULT)
